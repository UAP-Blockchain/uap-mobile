    ...
    return (
      <View style={styles.drawerContainer}>
        ...
        <View style={styles.menuContainer}>
          <Pressable
            onPress={() => {
              router.push("/(teacher)/index" as any);
            }}
            style={({ pressed }) => [
              styles.menuItem,
          ...
          >
            <MaterialCommunityIcons
              ...
              color={palette.primary}
            />
            <Text style={styles.menuItemText}>Lịch giảng dạy</Text>
          </Pressable>
          ...
          >
            <MaterialCommunityIcons
              ...
              color={palette.primary}
            />
            <Text style={styles.menuItemText}>Lớp giảng dạy</Text>
          </Pressable>
          ...
          >
            <MaterialCommunityIcons
              ...
              color={palette.primary}
            />
            <Text style={styles.menuItemText}>Chấm điểm</Text>
          </Pressable>
